...
async function verifyCloudinarySetup() {
  ...
  try {
    ...
    // Test 5: Generate URL
    console.log('5️⃣ Testing URL generation...');
    ...
    console.log('6️⃣ Testing upload from URL...');
    ...
    console.log('7️⃣ Testing image deletion...');
    ...
    console.log(`✅ Images deleted: ${deleteResult1 && deleteResult2}\n`);
